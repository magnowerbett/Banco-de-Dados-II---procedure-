...
CREATE TABLE `logestoque` (
  ...
  `QuantidadeAntiga` int DEFAULT NULL,
  `QuantidadeNova` int DEFAULT NULL,
  `DataModificacao` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`LogID`),
  KEY `ProdutoID` (`ProdutoID`),
  CONSTRAINT `logestoque_ibfk_1` FOREIGN KEY (`ProdutoID`) REFERENCES `produtos` (`ProdutoID`)
...
-- Dump completed on 2023-12-20  2:19:17
